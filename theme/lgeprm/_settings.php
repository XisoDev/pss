...
$addHtmlHeader[] = '<link rel="stylesheet" href="'.$domain.$module_info->theme_path.'assets/bower_components/jquery-ui/themes/ui-lightness/jquery-ui.min.css">';
...
$addHtmlHeader[] = '<script src="'.$domain.$module_info->theme_path.'js/toastem.js"></script>';
...
echo "<section class=\"content-header\">";
    ...
    echo "<ol class=\"breadcrumb\">";
        echo "<li><a href=\"{$domain}\"><i class=\"fa fa-home\"></i> Home</a></li>";
